...
const LANGUAGES = ['Python', 'TypeScript', 'JavaScript', 'Go', 'Rust', 'Java', 'C#', 'C++', 'Ruby', 'Swift', 'PHP', 'Kotlin'];
const FRAMEWORKS = [
    'React',
    'Next.js',
    'Vue',
...
const DOMAINS = ['AI / ML', 'Web Dev', 'DevOps / Cloud', 'Mobile', 'Embedded', 'Data Engineering', 'Security', 'Blockchain'];
const LOCATIONS = ['Germany', 'Austria', 'Switzerland', 'Netherlands', 'USA', 'UK', 'France', 'Canada', 'India', 'Remote'];
...
const tabCls = (active: boolean) => `tab gap-1.5 font-medium text-sm ${active ? 'tab-active' : 'text-base-content/50'}`;
        ...
        <div className="flex flex-wrap gap-2">
            {options.map((opt) => (
                <label key={opt} className="cursor-pointer select-none">
                    <input type="checkbox" value={opt} {...register(fieldName)} className="sr-only peer" />
...
export default function SearchPage() {
    ...
    const { onSubmit, modalOpen, setModalOpen, agentOneStarted, agentOneFinished, agentTwoStarted, agentTwoFinished, scoredProfiles, statusText } =
        useSearch();
                        ...
                        <ul className="steps steps-horizontal w-full text-xs">
                            <li className="step step-primary step-no-line">
                                <span className="flex items-center gap-1">
                                    <Bot size={12} /> Set Criteria
                                </span>
                            </li>
                            <li className="step step-primary step-no-line">
                                <span className="flex items-center gap-1">
                                    <Search size={12} /> Agent 1 searches GitHub
                                </span>
                            </li>
                            <li className="step step-primary step-no-line">
                                <span className="flex items-center gap-1">
                                    <BarChart2 size={12} /> Agent 2 screens &amp; ranks
                                </span>
                            </li>
                            <li className="step step-primary step-no-line">
                                <span className="flex items-center gap-1">
                                    <ChevronRight size={12} /> You review Top 3
                                </span>
                            </li>
                        </ul>
                    </div>
