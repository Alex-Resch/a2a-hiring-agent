import type {CalendarPhase2Request, FreeSlot, SelectedProfile} from "../../shared/models.ts";
...
export function useSetFreeSlot() {
    ...
    const onSubmit = async (selectedSlot: FreeSlot, selectedProfiles: SelectedProfile[]) => {
        ...
        await streamFetch("/calendar/schedule", calendarPhase2Request, (response: any) => {
    ...
    return { onSubmit, creatingAppointmentStarted, agentThreeIsDone: agentThreeFinished, isError }
}